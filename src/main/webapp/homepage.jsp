...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* PREVIEW */
    .preview-section-title { text-align: center; font-size: 14px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; color: var(--green); margin: 60px 0 20px; }
    .preview-wrap { position: relative; z-index: 1; margin: 0 auto; width: 100%; max-width: 860px; animation: fadeUp .8s .5s ease both; padding: 0 20px; }
    .preview-shell { background: var(--card-bg); border: 1px solid var(--card-border); border-radius: 20px; overflow: hidden; box-shadow: 0 40px 100px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.04); display: flex; flex-direction: column; }
    ...
    .preview-bar-url { margin-left: 12px; flex: 1; background: rgba(255,255,255,0.05); border-radius: 8px; padding: 5px 14px; font-size: 12px; color: var(--text-muted); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    ...
    .preview-main { padding: 24px; display: flex; flex-direction: column; gap: 16px; min-width: 0; }
    ...
    .preview-bar-chart { display: flex; align-items: flex-end; justify-content: space-between; gap: 6px; height: 60px; margin-top: 10px; }
    .bar { flex: 1; background: rgba(35,165,90,0.2); border-radius: 4px; }
    ...
    @media (min-width: 901px) {
      .feat-ai-card { grid-column: span 2; }
    }
...
<!-- App Preview -->
  <div class="preview-wrap">
    <div class="preview-section-title">App Preview</div>
...
<section class="section">
  ...
  <div class="features-grid">
    ...
    <div class="feature-card animate-in feat-ai-card" style="--glow: rgba(168,85,247,0.08)">
