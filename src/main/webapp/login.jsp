...
<form id="register action="register" method="post" onsubmit="return false;">
      ...
      <div class="slides" id="slides">
        ...
        <div class="slide">
          ...
          <div class="field">
            ...
            <input type="text" id="fullname" name="fullname" placeholder="Alex Johnson" autocomplete="name">
        ...
        <div class="slide">
          ...
          <div class="field">
            ...
            <input type="number" id="height" name="height" placeholder="175" min="50" max="250">
